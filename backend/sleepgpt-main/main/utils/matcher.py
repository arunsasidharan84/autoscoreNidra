...
from .box_ops import box_cxw_to_x, generalized_box_iou
...
class HungarianMatcher(nn.Module):
    ...
    def forward(self, outputs, targets):
        ...
        """
        bs, num_queries = outputs["pred_boxes"].shape[:2]  # outputs: batch_size, n_q, 2
        ...
        cost_giou = -generalized_box_iou(box_cxw_to_x(out_bbox), box_cxw_to_x(tgt_bbox))
        ...
        rank_zero_info(f'C.split(sizes, -1): {C.split(sizes, -1)}')
