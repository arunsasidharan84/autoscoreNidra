...
def main():
    ...
    parser.add_argument("--data_dir", type=str,
                        # default="/Volumes/T7/data/ISRUC/processed",
                        default="/home/cuizaixu_lab/huangweixuan/data/ISRUC/processed",
    ...
    np.save(os.path.join(args.data_dir, f'ISRUC_S1_split_k_10_noval'), arr=res, allow_pickle=True)
