...
def main():
    ...
    parser.add_argument("--data_dir", type=str,
                        default="/Volumes/T7/data/Physio/Physio/training",
    ...
    np.save(os.path.join(args.output_dir, f'physio_downstream_usleep'), arr=res, allow_pickle=True)
    print(f'len: names: {len(names)}')
    print(f"save path: {os.path.join(args.output_dir, f'physio_downstream_usleep')}")
