...
srun python3 main_kfold.py with finetune_mass_stage  MASS2_aug_random_datasets   repeat \
  ...
  resume_during_training=0 resume_ckpt_path="" kfold=1  mode='Finetune_mass_portion_1' \
