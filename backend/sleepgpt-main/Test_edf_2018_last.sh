...
srun python3 main_test_last.py with finetune_edf   \
  ...
  layer_decay=0.75 Lambda=1.0 patch_size=200 use_cb=True kfold=8 grad_name='all' \
  kfold_test=2 eval=True dist_on_itp=False EDF_Mode='2018_Finetune'