...
srun python3 main_test_kfold.py with finetune_mass_stage   visualization_umap_MASS \
  ...
  layer_decay=0.75 Lambda=1.0 patch_size=200 use_cb=True kfold=14 grad_name='all' \
