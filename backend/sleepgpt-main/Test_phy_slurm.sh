...
load_path=/home/cuizaixu_lab/huangweixuan/data/checkpoint/Finetune_phy_cosine_backbone_large_patch200_adamw_finetune_all_timeswin/1_fold/version_0/ModelCheckpoint-epoch=99-val_acc=0.8200-val_score=5.3237.ckpt
srun python3 main_test_kfold_persub.py with finetune_phy  visualization_umap_phy \
  ...
  layer_decay=0.75 Lambda=1.0 patch_size=200 use_cb=True kfold=2 grad_name='all' \
