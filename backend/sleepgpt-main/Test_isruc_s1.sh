...
srun python3 main_test_kfold.py with finetune_ISRUC_S1   ISRUC_S1   \
  ...
  layer_decay=0.75 Lambda=1.0 patch_size=200 use_cb=True kfold=7 grad_name='all' \
