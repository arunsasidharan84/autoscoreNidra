...
srun python3 main_kfold.py with finetune_edf  edf_ft_usleep  seed=2019  \
  ...
  layer_decay=0.75 Lambda=1.0 patch_size=200 use_cb=True kfold=1 grad_name='all' save_top_k=5 \
