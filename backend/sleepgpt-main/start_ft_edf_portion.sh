...
srun python3 main_kfold.py with finetune_edf  edf_portion_5_datasets  edf_datasets repeat \
  num_gpus=2 num_nodes=1 num_workers=18 batch_size=12 model_arch=backbone_large_patch200  lr_mult=20 \
