...
srun python3 main_kfold.py with finetune_phy  finetune_phy_usleep \
  num_gpus=4 num_nodes=1 num_workers=32 batch_size=8 model_arch=backbone_large_patch200  lr_mult=20 \
  ...
  layer_decay=0.75 Lambda=1.0 patch_size=200 use_cb=True grad_name='all' save_top_k=5 \
