...
srun python3 main_kfold.py with finetune_edf  edf_ft_mul \
  num_gpus=2 num_nodes=1 num_workers=8 batch_size=24 model_arch=backbone_large_patch200  lr_mult=20 \
  ...
  layer_decay=0.75 Lambda=1.0 patch_size=200 use_cb=True kfold=5 grad_name='all' save_top_k=5 \
