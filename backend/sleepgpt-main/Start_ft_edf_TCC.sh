...
srun python3 main_kfold.py with finetune_edf  edf_ft_TCC seed=2019 \
  num_gpus=1 num_nodes=1 num_workers=4 batch_size=8 model_arch=backbone_large_patch200  lr_mult=20 \
  warmup_lr=0 val_check_interval=0.2 check_val_every_n_epoch=1 limit_train_batches=1.0 max_steps=-1 all_time=True time_size=20 decoder_features=768 pool=None \
  ...
  layer_decay=0.75 Lambda=1.0 patch_size=200 use_cb=True kfold=1 grad_name='all' save_top_k=5   subset=0.01 \
