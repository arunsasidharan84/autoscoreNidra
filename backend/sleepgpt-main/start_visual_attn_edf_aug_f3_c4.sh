...
srun python3 main_test_last.py with finetune_edf  edf_2018 edf_aug_f3_c4_datasets  \
  num_gpus=1 num_nodes=1 num_workers=9 batch_size=14 model_arch=backbone_large_patch200  lr_mult=20 \
  ...
  resume_during_training=0 resume_ckpt_path="" EDF_Mode='2018_F3_C4' return_alpha=True \
  eval=True dist_on_itp=False kfold_test=0 kfold=3