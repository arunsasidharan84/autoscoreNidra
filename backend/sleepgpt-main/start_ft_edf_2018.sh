...
srun python3 main_kfold.py with finetune_edf   \
  ...
  lr=1e-3 min_lr=0 random_choose_channels=8 max_epoch=35 lr_policy=cosine loss_function='l1' drop_path_rate=0.2 warmup_steps=0.1 split_len=20 \
  load_path=$load_path \
  ...
  layer_decay=0.75 Lambda=1.0 patch_size=200 use_cb=True kfold=6 grad_name='all' EDF_Mode='2018_Finetune' \
