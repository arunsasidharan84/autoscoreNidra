...
srun python3 main_test_kfold.py with finetune_edf  edf_2018 edf_aug_consecutive_datasets   \
  ...
  kfold_test=1 eval=True dist_on_itp=False EDF_Mode='2018_consecutive' use_triton=True