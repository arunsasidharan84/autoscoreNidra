...
num_gpus=2 num_nodes=2 num_workers=32 batch_size=640 model_arch=backbone_base_patch200 \
lr=5e-5 min_lr=5e-8 warmup_lr=5e-8 random_choose_channels=4 max_epoch=50 lr_policy=cosine loss_function='l1' \
warmup_steps=0.1 val_check_interval=1.0 Lambda=1.0 optim="adamw" mask_ratio=0.75 \
load_path=$load_path extra_name="Unify" all_time=True split_len=1 time_size=1