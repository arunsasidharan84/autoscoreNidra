...
load_path=/home/cuizaixu_lab/huangweixuan/data/checkpoint/Finetune_edf_TCC_cosine_backbone_large_patch200_adamw_Other_EDF_Finetune_all_timeswin_TCC/0_fold/version_0/ModelCheckpoint-epoch=40-val_acc=0.8960-val_macro=0.8253-val_score=6.7213.ckpt
#srun python3 main_test_kfold.py with finetune_edf edf_ft_TCC  visualization_umap_edf_2013_TCC seed=2023  \
...
srun python3 main_test_kfold_persub.py with finetune_edf edf_datasets edf_ft_TCC  visualization_umap_edf_2013_TCC seed=2023  \
  num_gpus=1 num_nodes=1 num_workers=9 batch_size=64 model_arch=backbone_large_patch200  lr_mult=20 \
  warmup_lr=0 val_check_interval=1.0 check_val_every_n_epoch=1 limit_train_batches=1.0 max_steps=-1 all_time=True time_size=20 decoder_features=768 pool=None \
  lr=1e-3 min_lr=0 random_choose_channels=8 max_epoch=50 lr_policy=cosine loss_function='l1' drop_path_rate=0.5 warmup_steps=0.1 split_len=20 \
  load_path=$load_path \
