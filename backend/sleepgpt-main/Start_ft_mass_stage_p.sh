...
srun python3 main_kfold.py with finetune_mass_stage  MASS2_datasets mode='Finetune_mass_ss2' repeat \
  ...
  resume_during_training=3 resume_ckpt_path="" save_top_k=1 \
  actual_channels="F3"