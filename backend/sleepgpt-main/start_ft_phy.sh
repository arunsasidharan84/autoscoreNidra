...
srun python3 main_kfold.py with finetune_phy   \
  num_gpus=8 num_nodes=2 num_workers=32 batch_size=10 model_arch=backbone_large_patch200  lr_mult=20 \
