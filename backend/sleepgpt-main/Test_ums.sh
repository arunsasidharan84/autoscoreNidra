...
#SBATCH --qos=high
#SBATCH --job-name=Test_ums_stage
#SBATCH --partition=GPU40G
#SBATCH --output=/lustre/home/2201210064/Sleep/temp_log/ums/%j.out
...
kfold_load_path=/lustre/home/2201210064/DATA/data/checkpoint
#load_path=/home/cuizaixu_lab/huangweixuan/data/checkpoint/Finetune_mass_all_cosine_backbone_large_patch200_adamw_Finetune_mass_all_all_timeswin/13_fold/version_1/ModelCheckpoint-epoch=49-val_acc=0.8820-val_macro=0.8329-val_score=6.7149.ckpt
srun python3 main_test_kfold_persub.py with finetune_ums  ums_wm2_F3_new_dataset \
  ...
  layer_decay=0.75 Lambda=1.0 patch_size=200 use_cb=True kfold=11 grad_name='all' \
  kfold_test=3 eval=True dist_on_itp=False